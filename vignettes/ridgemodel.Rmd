...
ridge_pred <- predict(ridge_model, newdata = as.matrix(test_data), interval = "prediction")
```
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- misc::ridgemodel(X = as.matrix(train_data[,-14]), y = train_data$medv)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- misc::ridgemodel(X = as.matrix(train_data[,-7]), y = train_data$Employed)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- misc::ridgemodel(X = as.matrix(train_data[,-16]), y = train_data$y)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- misc::ridgemodel(X = as.matrix(train_data[,-which(names(train_data) == "Price")]), 
                               y = train_data$Price)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
